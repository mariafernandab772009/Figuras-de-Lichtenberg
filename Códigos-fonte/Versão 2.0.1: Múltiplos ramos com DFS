...
# ani.save('MultiploRamoDFS.gif', writer='pillow', fps=5, dpi=100)
plt.show()

# SALVA A ANIMAÇÃO
print("Salvando animação como MultiploRamoDFS.gif... Aguarde.")
ani.save('MultiploRamoDFS.gif', writer='pillow', fps=15)
